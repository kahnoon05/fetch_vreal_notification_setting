...
def get_token(platform):
    ...
    if "Intel" in platform:
        ...
        if platform == 'HPE_dom1,2':
            ...
            body = {"username": "nocinet", "password": "1Net@Hpe64", "authSource": "Local"}
            headers = {
                "Content-Type": "application/json",
                "Accept": "application/json"
            }
...
def get_notification_setting_data(token, platform):
    if "Intel" in platform:
        if platform == 'Intel_dom4':
            fetch_data_from_vm_url = 'https://172.23.15.99/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
    ...
    if "HPE" in platform:
        if platform == 'HPE_dom1,2':
            fetch_data_from_vm_url = 'https://hpcloud-healthmonitor.inet.co.th/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpecloudservicemonitor.inet.co.th/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpcloudsimplivitymonitor.inet.co.th/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        if platform == 'Flexpod_dom1':
            fetch_data_from_vm_url = 'https://10.20.80.35/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://vrealize.inet.co.th/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://10.100.10.25/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://203.154.44.131/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        if platform == 'Dell_dom2':
            fetch_data_from_vm_url = 'https://192.168.8.43/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.11.229/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.10.24/suite-api/api/notifications/rules?page=0&amp;pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
...
def convert_uuid_to_vmname(token, platform):
    if "Intel" in platform:
        if platform == 'Intel_dom4':
            fetch_data_from_vm_url = 'https://172.23.15.99/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
    ...
    if "HPE" in platform:
        if platform == 'HPE_dom1,2':
            fetch_data_from_vm_url = 'https://hpcloud-healthmonitor.inet.co.th/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpecloudservicemonitor.inet.co.th/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://hpcloudsimplivitymonitor.inet.co.th/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        if platform == 'Flexpod_dom1':
            fetch_data_from_vm_url = 'https://10.20.80.35/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://vrealize.inet.co.th/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://10.100.10.25/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://203.154.44.131/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
        ...
        if platform == 'Dell_dom2':
            fetch_data_from_vm_url = 'https://192.168.8.43/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.11.229/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
            ...
            fetch_data_from_vm_url = 'https://192.168.10.24/suite-api/api/resources?resourceKind=virtualmachine&pageSize=2000'
            headers = {
                "Authorization": token,
                "Accept": "application/json",
                "Content-Type": "application/json"
